...
((Power cobra))::
    Esercizio dinamico che comporta il passare in maniera alternata dalla posizione <<bhujangasana, cobra>> a quella <<accosciata, accosciata>>
...
Clean:: Esercizio in 4 step. 
    ...
    Varianti::: 
        ...
        * _((power clean))_ +
        variazione del punto 3: ferma la barra a mezzo <<accosciata, squat>>. Questa versione necessita che la barra sia lanciata più in alto.
